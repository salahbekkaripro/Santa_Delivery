...
%\AddToShipoutPicture*{\EtiquetteThese}
  ...
  \centering
    ...
    \vspace{1cm}
      {\huge
      	{\bfseries Rapport de projet\\ Graphes et Open data}\\
    \vspace{0.5cm}}
      	$\ $\\
    \vspace{1cm}
    ...
    \vspace{0.35cm}
    {\small D\'{e}p\^{o}t GitHub~: \href{https://github.com/salahbekkaripro/Santa_Delivery}{github.com/salahbekkaripro/Santa\_Delivery}}\\
